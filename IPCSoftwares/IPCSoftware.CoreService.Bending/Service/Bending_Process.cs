...
namespace IPCSoftware.CoreService.Bending.Service
{
    ...
    public class BendingProcessService
    {
        ...
        private readonly HashSet<string> _b1DataRecorded = new();
        private readonly HashSet<string> _b2DataRecorded = new();
        // Track B3 data completion per batch (needed for Stage 4→5 precondition)
        private readonly HashSet<string> _b3DataRecorded = new();
